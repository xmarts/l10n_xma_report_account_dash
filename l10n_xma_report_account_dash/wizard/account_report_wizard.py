...
class AccountReportWizard(models.TransientModel):
    ...
    def print_pdf(self):
        ...
        return self.env.ref('l10n_xma_report_account_dash.action_account_report_template').report_action(self, data=datas)
    ...
    def print_xlsx(self):
        ...
        return self.env.ref('l10n_xma_report_account_dash.action_account_report_xlsx').report_action(self, data=datas)
