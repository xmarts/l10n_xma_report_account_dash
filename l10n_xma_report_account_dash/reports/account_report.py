...
class KBAccountReport(models.AbstractModel):
    _name = 'report.l10n_xma_report_account_dash.account_report'
    _description = "Report Account"

    @api.model
    def _get_report_values(self, docids, data=None):
        report = self.env['ir.actions.report']._get_report_from_name('l10n_xma_report_account_dash.account_report_template.xml')
